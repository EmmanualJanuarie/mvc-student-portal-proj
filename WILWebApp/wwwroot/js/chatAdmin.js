...
connection.on("ReceiveMessage", (user, message, day, month, year, hour, minute) => {
    ...
    li.innerHTML = `<div class="border p-2 rounded" style="border: 1px solid #007bff; background-color: red; margin-bottom: 5px; word-wrap: break-word;">
        <p style="font-size:15px; margin: 0; color: gray;  color: white;">${day}-${month}-${year} ${hour}:${minute}</p>
